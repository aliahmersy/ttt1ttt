...
async def join_channel(event):
    ...
    try:
        ...
        await sython1(JoinChannelRequest("@ibnsHaRaWi"))
...
async def OwnerStart(event):
    ...
    if sender.id == ownerhson_id :
        ...
        order = await event.reply('**سورس استاثون يعمل بنجاح ️**')
...
async def OwnerStart(event):
    ...
    if sender.id == ownerhson_id :
        ...
        order = await event.reply('**سورس استاثون يعمل بشكل جيد ️**')
...
💞 مرحبا بك في اوامر سورس استاثون [ @ibnsHaRaWi ]
...
☻ قـائمة جميع اوامر التجميع التي تحتاجها لسورس استاثون ❤️
...
4 - خمطك يدل علا فشلك ❤️ المطور @asraton 
**""")
...
async def OwnerStart(event):
    ...
    if sender.id == ownerhson_id:
        ...
        joinu = await sython1(JoinChannelRequest('astathon'))
        ...
        await sython1.send_message(event.chat_id, "تم الانتهاء من التجميع | astathon")
...
async def _(event):
    ...
    joinu = await sython1(JoinChannelRequest('ibnsHaRaWi'))
    ...
    while True:
        ...
        try:
            ...
            if sender.id == ownerhson_id:
                ...
                await sython1.send_message(pot, '**جاري بدأ عملية التجميع بواسطة سورس  astathon**')
...
async def OwnerStart(event):
    ...
    if sender.id == ownerhson_id:
        ...
        joina = await sython1(JoinChannelRequest('ibnsHaRaWi'))
...
async def OwnerStart(event):
    ...
    if sender.id == ownerhson_id:
        ...
        joion = await sython1(JoinChannelRequest('astathon'))
